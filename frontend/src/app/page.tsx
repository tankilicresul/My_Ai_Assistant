...
export default function HomePage() {
  const modules = [
    {
      title: "1. ChatGPT Modülü",
      description: "GPT-4o, Claude 3.7, Gemini 2.0, DeepSeek R1, Qwen & Llama ile çoklu model sohbet, sesli iletişim ve zengin markdown.",
      icon: MessageSquare,
      href: "/chat",
      color: "from-blue-500 to-indigo-600",
      badge: "Multi-Model LLM",
    },
    {
      title: "2. Claude Code Stüdyosu",
      description: "Dosya sistemi, web tabanlı terminal, Monaco kod editörü, Git entegrasyonu, otomatik hata ayıklama ve test üretimi.",
      icon: Code2,
      href: "/code",
    ...
    {
      title: "3. Görsel & Video Stüdyosu",
      description: "Flux 1 Pro, SDXL, Wan 2.1, CogVideoX, Kling ve Veo modelleri ile fotogerçekçi görsel ve sinematik video üretimi.",
      icon: Sparkles,
      href: "/studio",
      color: "from-pink-500 to-rose-600",
      badge: "Higgsfield Stili",
    },
    {
      title: "4. Gemini Deep Research",
      description: "Otonom çok adımlı web araştırması, güvenilirlik puanlamalı kaynak doğrulama ve detaylı PDF/Markdown raporlama.",
      icon: Compass,
      href: "/research",
    ...
    {
      title: "5. Vektörel Hafıza Motoru",
      description: "Qdrant vektör veritabanı ile kullanıcı tercihleri, iş deneyimleri, projeler ve geçmiş konuşmaların semantik saklanması.",
      icon: Database,
      href: "/memory",
    ...
    {
      title: "6. Dosya Analiz & Grafik Motoru",
      description: "PDF, Excel (XLSX), Word, CSV ve JSON dosyalarını işleme, istatistik çıkarma ve otomatik analitik grafik önerileri.",
    ...
    {
      title: "7. Agent Marketplace",
      description: "Özelleştirilmiş satın alma, muhasebe, veri analizi ve yazılım mimarı agentları oluşturma ve otonom çalıştırma.",
      icon: Bot,
      href: "/marketplace",
    ...
    {
      title: "8. Admin Observability",
      description: "Kullanıcı yönetimi, model bazında token tüketimi, tahmini API maliyetleri, hata izleme ve audit logları.",
      icon: ShieldAlert,
      href: "/admin",
      color: "from-red-500 to-orange-600",
      badge: "Admin & Cost Analytics",
    },
  ];
